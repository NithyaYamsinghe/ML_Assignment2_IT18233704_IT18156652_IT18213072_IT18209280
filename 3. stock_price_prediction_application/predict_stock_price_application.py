...
options = " Stock Linear Regression Prediction, Stock Logistic Regression Prediction, Desicion Tree Regression, Bayesian Ridge Regression, Exit".split(",")
...
def beginning():
    print()
    print("----------Welcome to Machine Learning Stock Price Predictions--------")
    print("""
